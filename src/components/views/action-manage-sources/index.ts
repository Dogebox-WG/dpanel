...
export class SourceManagerView extends LitElement {
  ...
  handleClosure(event: Event) {
    // Check if the event target is the dialog with id "ManageSourcesDialog"
    if ((event.target as HTMLElement).id === "ManageSourcesDialog") {
            ...
            <action-row 
              ...
              <div class="dropdown-selection-alt" slot="suffix">
                <sl-dropdown hoist>
                  ...
                  <sl-menu>
                    <sl-menu-item value="refres" @click=${() => this.handleRefreshClick()}>Refresh</sl-menu-item>
