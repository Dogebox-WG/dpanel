...
export class RemoteAccessSettings extends LitElement {
  ...
  declare _server_fault: string;
  declare _ssh_public_keys: SSHPublicKey[];
  declare _expanded_key: string;
  declare _show_add_key_dialog: boolean;
  declare _selected_key_id_for_trash: string;
  declare _show_private_key_warning: boolean;
  declare _new_key_value: string;
  declare _ssh_state: SSHState;

  _inflight_state_fetch?: boolean;
  ...
  render() {
    ...
    return html`
      ...
      <sl-dialog @sl-request-close=${(e: Event) => { this._selected_key_id_for_trash = ""; e.stopPropagation();}} ?open=${this._selected_key_id_for_trash} label="Are you sure?">
      ...
      <sl-dialog @sl-request-close=${(e: Event) => { this._show_add_key_dialog = false; e.stopPropagation(); }} ?open=${this._show_add_key_dialog} label="Add an SSH Public Key">
        <sl-textarea
