...
export class LocationPickerView extends LitElement {
  ...
  declare _inflight_disks: boolean;
  declare _page: string;
  declare _disks: Disk[];
  declare _selected_disk_index: number | null;
  declare _confirmation_checked: boolean;
  declare _inflight_install: boolean;
  declare _install_outcome: string;
  declare _logs: { msg: string }[];

  existingInstallationDialogOpen: boolean;
  mainDialogOpen: boolean;
  _allDisks: Disk[];
  _installDisks: Disk[];
  _bootMediaDisk: Disk | null;
  _header: string;
  _unsubscribe: (() => void) | null;
  _fetchDisks: boolean;
  _disks_fetched: boolean;
  ...
  handleDiskSelection = (e: Event, row: HTMLElement) => {
