...
export class ConfirmationPrompt extends LitElement {
  ...
  declare topButtonText: string | undefined;
  declare topButtonVariant: string;
  declare topButtonClick: (() => void) | undefined;
  declare bottomButtonText: string | undefined;
  declare bottomButtonVariant: string;
  declare bottomButtonClick: (() => void) | undefined;

  _topButtonClick: () => void;
  _bottomButtonClick: () => void;
