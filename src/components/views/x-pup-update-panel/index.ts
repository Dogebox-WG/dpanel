...
import type { PupVersion } from "/types/pup-updates";
...
class PupUpdatePanel extends LitElement {
  ...
  declare currentVersion: string | undefined;
  declare _selectedVersion: string | null;
  declare _isUpgrading: boolean;
  ...
  _handleVersionChange(e: CustomEvent<{ version: string }>) {
  ...
  _formatDate(dateStr: string | undefined) {
    if (!dateStr) return '';
  ...
  _renderReleaseNotes(notes: string | undefined) {
